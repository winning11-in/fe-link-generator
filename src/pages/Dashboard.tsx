            ...
            <Row gutter={[16, 16]} style={{ marginBottom: 32 }}>
              <Col xs={24} sm={12} md={8}>
                ...
                >
                  ...
                  <Title level={4} style={{ margin: 0, marginBottom: 8, color: '#1a1a1a' }}>
                    Start from Scratch
                  </Title>
              ...
              <Col xs={24} sm={12} md={8}>
                <Card
                  ...
                  style={{
                    ...
                    background: 'linear-gradient(135deg, rgba(250, 140, 22, 0.05) 0%, rgba(250, 173, 20, 0.05) 100%)',
                    cursor: 'pointer',
                    transition: 'all 0.3s ease',
                  }}
                  bodyStyle={{ padding: 32, textAlign: 'center' }}
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.transform = 'translateY(-4px)';
                    e.currentTarget.style.boxShadow = '0 8px 24px rgba(250, 140, 22, 0.2)';
                  }}
                  onMouseLeave={(e) => {
